...
#define PLUGIN1                   dDScope //    OFF, Specify the class instance (same as plugin directory name) to enable.    Option
#include "DDScope/DDScope.h"              //         Specify the header file to include the class.
